...
Displays gallery in a grid. You can add custom links to all images and captions.
...
Requires [**Media Library Custom Fields**](http://abcfolio.com/help/wordpress-media-library-custom-fields/) plugin to be installed.
